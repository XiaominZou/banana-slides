  ...
  zh: {
    landing: {
      ...
      hero: {
        ...
        title_end: "无需繁琐排版",
        subtitle: "专注于您的内容与想法，剩下的交给 Slides Now。从大纲到精美幻灯片，只需几分钟。",
        cta_primary: "免费开始使用"
      }
    }
  },
  en: {
    landing: {
      ...
      hero: {
        ...
        subtitle: "Focus on your content and ideas, leave the rest to Slides Now. From outline to beautiful slides in seconds.",
